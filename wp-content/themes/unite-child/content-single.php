...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		...
		?>
		<?php echo list_posts_by_taxonomy( 'films', 'genre',  get_the_ID())."<br/>"; ?>
		<?php echo list_posts_by_taxonomy( 'films', 'year',  get_the_ID())."<br/>"; ?>
        <strong>Ticket Price: </strong>
        <?php echo esc_html( get_post_meta( get_the_ID(), 'ticket_price', true ) ); ?>
        <br />
